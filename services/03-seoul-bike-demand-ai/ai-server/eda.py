...
# 4-3. 컬럼 확인
print(df.columns)
# 🔥 Target(정답) 값은 무엇일까요? Rented Bike Count
# 🔥 Feature(입력값) 값은 무엇일까요? Temperature, Humidity, Wind speed, Rainfall, Sonwfall, Hour, Season
